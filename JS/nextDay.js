window.onload = function(){
    ...
    //赋值给week,加一变为下一天
    var week = changeWeek(returnDay(time.getDay()) + 1);
    //赋值回h2
    ...
    var weekNumber =Math.floor((time - dateBegin + 24 * 60 * 60 * 1000)/ (7 * 24 * 60 * 60 * 1000)) + 1;
    //赋值给h2标签
    ...
    //运行
    inputClasses(returnWeek(returnDay(time.getDay())+1));
